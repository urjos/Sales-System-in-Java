...
public class ControlClientes implements ActionListener {
    ...
    public ControlClientes(Clientes modelo, ConsultasClientes consultas, frmClientes vista, Menu vistaMenu){
        this.modelo = modelo;
    ...
    public void cargarTabla() {
        DefaultTableModel modeloTabla = (DefaultTableModel) vista.tClientes.getModel();
        ...
        String sql = "SELECT * FROM clientes"; // Consulta SQL para obtener todos los datos
